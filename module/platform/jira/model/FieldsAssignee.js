...
/**
 * The FieldsAssignee model module.
 * @module model/FieldsAssignee
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class FieldsAssignee {
    /**
     * Constructs a new <code>FieldsAssignee</code>.
     * The assignee of the linked issue.
     * @alias module:model/FieldsAssignee
     * @implements module:model/UserDetails
     */
    constructor() { 
        UserDetails.initialize(this);
        FieldsAssignee.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FieldsAssignee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FieldsAssignee} obj Optional instance to populate.
     * @return {module:model/FieldsAssignee} The populated <code>FieldsAssignee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FieldsAssignee();
    ...
    /**
     * Validates the JSON data with respect to <code>FieldsAssignee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FieldsAssignee</code>.
     */
 ...
 */
FieldsAssignee.prototype['accountId'] = undefined;

/**
 * The type of account represented by this user. This will be one of 'atlassian' (normal users), 'app' (application user) or 'customer' (Jira Service Desk customer user)
 * @member {String} accountType
 */
FieldsAssignee.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
FieldsAssignee.prototype['active'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
FieldsAssignee.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy settings, this may return an alternative value.
 * @member {String} displayName
 */
FieldsAssignee.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} emailAddress
 */
FieldsAssignee.prototype['emailAddress'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
FieldsAssignee.prototype['key'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
FieldsAssignee.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
FieldsAssignee.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} timeZone
 */
FieldsAssignee.prototype['timeZone'] = undefined;
