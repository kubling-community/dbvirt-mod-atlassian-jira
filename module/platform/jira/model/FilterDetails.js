...
import FilterDetailsOwner from './FilterDetailsOwner';
...
class FilterDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = FilterDetailsOwner.constructFromObject(data['owner']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['owner']) { // data not null
          FilterDetailsOwner.validateJSON(data['owner']);
        }
        // ensure the json data is a string
 ...
 */
FilterDetails.prototype['approximateLastUsed'] = undefined;
...
/**
 * @member {module:model/FilterDetailsOwner} owner
 */
