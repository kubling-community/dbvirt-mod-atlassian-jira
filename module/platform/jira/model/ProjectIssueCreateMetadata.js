...
import ProjectIssueCreateMetadataAvatarUrls from './ProjectIssueCreateMetadataAvatarUrls';
...
class ProjectIssueCreateMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('avatarUrls')) {
                obj['avatarUrls'] = ProjectIssueCreateMetadataAvatarUrls.constructFromObject(data['avatarUrls']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['avatarUrls']) { // data not null
          ProjectIssueCreateMetadataAvatarUrls.validateJSON(data['avatarUrls']);
        }
...
/**
 * @member {module:model/ProjectIssueCreateMetadataAvatarUrls} avatarUrls
 */
