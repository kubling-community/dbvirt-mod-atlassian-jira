...
/**
 * The GetFeaturesForBoard200ResponseFeaturesInner model module.
 * @module model/GetFeaturesForBoard200ResponseFeaturesInner
 * @version 1001.0.0
 */
class GetFeaturesForBoard200ResponseFeaturesInner {
    /**
     * Constructs a new <code>GetFeaturesForBoard200ResponseFeaturesInner</code>.
     * @alias module:model/GetFeaturesForBoard200ResponseFeaturesInner
     */
    constructor() { 
        
        GetFeaturesForBoard200ResponseFeaturesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetFeaturesForBoard200ResponseFeaturesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetFeaturesForBoard200ResponseFeaturesInner} obj Optional instance to populate.
     * @return {module:model/GetFeaturesForBoard200ResponseFeaturesInner} The populated <code>GetFeaturesForBoard200ResponseFeaturesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetFeaturesForBoard200ResponseFeaturesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetFeaturesForBoard200ResponseFeaturesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFeaturesForBoard200ResponseFeaturesInner</code>.
     */
...
/**
 * @member {module:model/GetFeaturesForBoard200ResponseFeaturesInner.BoardFeatureEnum} boardFeature
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['boardFeature'] = undefined;

/**
 * @member {Number} boardId
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['boardId'] = undefined;

/**
 * @member {String} featureId
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['featureId'] = undefined;

/**
 * @member {module:model/GetFeaturesForBoard200ResponseFeaturesInner.FeatureTypeEnum} featureType
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['featureType'] = undefined;

/**
 * @member {String} imageUri
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['imageUri'] = undefined;

/**
 * @member {String} learnMoreArticleId
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['learnMoreArticleId'] = undefined;

/**
 * @member {String} learnMoreLink
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['learnMoreLink'] = undefined;

/**
 * @member {String} localisedDescription
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['localisedDescription'] = undefined;

/**
 * @member {String} localisedGroup
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['localisedGroup'] = undefined;

/**
 * @member {String} localisedName
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['localisedName'] = undefined;
 ...
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['permissibleEstimationTypes'] = undefined;

/**
 * @member {module:model/GetFeaturesForBoard200ResponseFeaturesInner.StateEnum} state
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['state'] = undefined;

/**
 * @member {Boolean} toggleLocked
 */
GetFeaturesForBoard200ResponseFeaturesInner.prototype['toggleLocked'] = undefined;
 ...
 * @readonly
 */
GetFeaturesForBoard200ResponseFeaturesInner['BoardFeatureEnum'] = {
 ...
 * @readonly
 */
GetFeaturesForBoard200ResponseFeaturesInner['FeatureTypeEnum'] = {
 ...
 * @readonly
 */
GetFeaturesForBoard200ResponseFeaturesInner['StateEnum'] = {
...
export default GetFeaturesForBoard200ResponseFeaturesInner;
