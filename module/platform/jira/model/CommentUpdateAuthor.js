...
/**
 * The CommentUpdateAuthor model module.
 * @module model/CommentUpdateAuthor
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class CommentUpdateAuthor {
    /**
     * Constructs a new <code>CommentUpdateAuthor</code>.
     * The ID of the user who updated the comment last.
     * @alias module:model/CommentUpdateAuthor
     * @implements module:model/UserDetails
     */
    constructor() { 
        UserDetails.initialize(this);
        CommentUpdateAuthor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CommentUpdateAuthor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CommentUpdateAuthor} obj Optional instance to populate.
     * @return {module:model/CommentUpdateAuthor} The populated <code>CommentUpdateAuthor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CommentUpdateAuthor();
    ...
    /**
     * Validates the JSON data with respect to <code>CommentUpdateAuthor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CommentUpdateAuthor</code>.
     */
 ...
 */
CommentUpdateAuthor.prototype['accountId'] = undefined;

/**
 * The type of account represented by this user. This will be one of 'atlassian' (normal users), 'app' (application user) or 'customer' (Jira Service Desk customer user)
 * @member {String} accountType
 */
CommentUpdateAuthor.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
CommentUpdateAuthor.prototype['active'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
CommentUpdateAuthor.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy settings, this may return an alternative value.
 * @member {String} displayName
 */
CommentUpdateAuthor.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} emailAddress
 */
CommentUpdateAuthor.prototype['emailAddress'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
CommentUpdateAuthor.prototype['key'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
CommentUpdateAuthor.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
CommentUpdateAuthor.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} timeZone
 */
CommentUpdateAuthor.prototype['timeZone'] = undefined;
...
export default CommentUpdateAuthor;
