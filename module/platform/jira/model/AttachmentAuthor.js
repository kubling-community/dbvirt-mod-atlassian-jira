...
/**
 * The AttachmentAuthor model module.
 * @module model/AttachmentAuthor
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class AttachmentAuthor {
    /**
     * Constructs a new <code>AttachmentAuthor</code>.
     * Details of the user who added the attachment.
     * @alias module:model/AttachmentAuthor
     * @implements module:model/UserDetails
     */
    constructor() { 
        UserDetails.initialize(this);
        AttachmentAuthor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachmentAuthor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachmentAuthor} obj Optional instance to populate.
     * @return {module:model/AttachmentAuthor} The populated <code>AttachmentAuthor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachmentAuthor();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachmentAuthor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachmentAuthor</code>.
     */
 ...
 */
AttachmentAuthor.prototype['accountId'] = undefined;

/**
 * The type of account represented by this user. This will be one of 'atlassian' (normal users), 'app' (application user) or 'customer' (Jira Service Desk customer user)
 * @member {String} accountType
 */
AttachmentAuthor.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
AttachmentAuthor.prototype['active'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
AttachmentAuthor.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy settings, this may return an alternative value.
 * @member {String} displayName
 */
AttachmentAuthor.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} emailAddress
 */
AttachmentAuthor.prototype['emailAddress'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
AttachmentAuthor.prototype['key'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
AttachmentAuthor.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
AttachmentAuthor.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} timeZone
 */
AttachmentAuthor.prototype['timeZone'] = undefined;
