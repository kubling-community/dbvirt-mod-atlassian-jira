...
/**
 * The WorkflowSchemeLastModifiedUser model module.
 * @module model/WorkflowSchemeLastModifiedUser
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class WorkflowSchemeLastModifiedUser {
    /**
     * Constructs a new <code>WorkflowSchemeLastModifiedUser</code>.
     * The user that last modified the draft workflow scheme. A modification is a change to the issue type-project mappings only. This property does not apply to non-draft workflows.
     * @alias module:model/WorkflowSchemeLastModifiedUser
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        WorkflowSchemeLastModifiedUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WorkflowSchemeLastModifiedUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorkflowSchemeLastModifiedUser} obj Optional instance to populate.
     * @return {module:model/WorkflowSchemeLastModifiedUser} The populated <code>WorkflowSchemeLastModifiedUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkflowSchemeLastModifiedUser();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkflowSchemeLastModifiedUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkflowSchemeLastModifiedUser</code>.
     */
 ...
 */
WorkflowSchemeLastModifiedUser.prototype['accountId'] = undefined;

/**
 * The user account type. Can take the following values:   *  `atlassian` regular Atlassian user account  *  `app` system account used for Connect applications and OAuth to represent external systems  *  `customer` Jira Service Desk account representing an external service desk
 * @member {module:model/WorkflowSchemeLastModifiedUser.AccountTypeEnum} accountType
 */
WorkflowSchemeLastModifiedUser.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
WorkflowSchemeLastModifiedUser.prototype['active'] = undefined;

/**
 * @member {module:model/UserApplicationRoles} applicationRoles
 */
WorkflowSchemeLastModifiedUser.prototype['applicationRoles'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
WorkflowSchemeLastModifiedUser.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
WorkflowSchemeLastModifiedUser.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} emailAddress
 */
WorkflowSchemeLastModifiedUser.prototype['emailAddress'] = undefined;

/**
 * Expand options that include additional user details in the response.
 * @member {String} expand
 */
WorkflowSchemeLastModifiedUser.prototype['expand'] = undefined;

/**
 * @member {module:model/UserGroups} groups
 */
WorkflowSchemeLastModifiedUser.prototype['groups'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
WorkflowSchemeLastModifiedUser.prototype['key'] = undefined;

/**
 * The locale of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} locale
 */
WorkflowSchemeLastModifiedUser.prototype['locale'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
WorkflowSchemeLastModifiedUser.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
WorkflowSchemeLastModifiedUser.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} timeZone
 */
WorkflowSchemeLastModifiedUser.prototype['timeZone'] = undefined;
 ...
 * @readonly
 */
WorkflowSchemeLastModifiedUser['AccountTypeEnum'] = {
...
export default WorkflowSchemeLastModifiedUser;
