...
class NewUserDetails {
     ...
     * @param products {Array.<String>} Products the new user has access to. Valid products are: jira-core, jira-servicedesk, jira-product-discovery, jira-software. To create a user without product access, set this field to be an empty array.
     */
    constructor(emailAddress, products) { 
        
        NewUserDetails.initialize(this, emailAddress, products);
    }
     ...
     */
    static initialize(obj, emailAddress, products) { 
...
NewUserDetails.RequiredProperties = ["emailAddress", "products"];
