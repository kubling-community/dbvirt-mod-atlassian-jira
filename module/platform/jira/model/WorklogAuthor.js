...
/**
 * The WorklogAuthor model module.
 * @module model/WorklogAuthor
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class WorklogAuthor {
    /**
     * Constructs a new <code>WorklogAuthor</code>.
     * Details of the user who created the worklog.
     * @alias module:model/WorklogAuthor
     * @implements module:model/UserDetails
     */
    constructor() { 
        UserDetails.initialize(this);
        WorklogAuthor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WorklogAuthor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WorklogAuthor} obj Optional instance to populate.
     * @return {module:model/WorklogAuthor} The populated <code>WorklogAuthor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorklogAuthor();
    ...
    /**
     * Validates the JSON data with respect to <code>WorklogAuthor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorklogAuthor</code>.
     */
 ...
 */
WorklogAuthor.prototype['accountId'] = undefined;

/**
 * The type of account represented by this user. This will be one of 'atlassian' (normal users), 'app' (application user) or 'customer' (Jira Service Desk customer user)
 * @member {String} accountType
 */
WorklogAuthor.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
WorklogAuthor.prototype['active'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
WorklogAuthor.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy settings, this may return an alternative value.
 * @member {String} displayName
 */
WorklogAuthor.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} emailAddress
 */
WorklogAuthor.prototype['emailAddress'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
WorklogAuthor.prototype['key'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
WorklogAuthor.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
WorklogAuthor.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy settings, this may be returned as null.
 * @member {String} timeZone
 */
WorklogAuthor.prototype['timeZone'] = undefined;
