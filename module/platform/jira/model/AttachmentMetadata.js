...
import AttachmentMetadataAuthor from './AttachmentMetadataAuthor';
...
class AttachmentMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('author')) {
                obj['author'] = AttachmentMetadataAuthor.constructFromObject(data['author']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AttachmentMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachmentMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `author`
        if (data['author']) { // data not null
          AttachmentMetadataAuthor.validateJSON(data['author']);
        }
...
/**
 * @member {module:model/AttachmentMetadataAuthor} author
 */
