...
/**
 * The FieldsStatus model module.
 * @module model/FieldsStatus
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class FieldsStatus {
    /**
     * Constructs a new <code>FieldsStatus</code>.
     * The status of the linked issue.
     * @alias module:model/FieldsStatus
     * @implements module:model/StatusDetails
     */
    constructor() { 
        StatusDetails.initialize(this);
        FieldsStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FieldsStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FieldsStatus} obj Optional instance to populate.
     * @return {module:model/FieldsStatus} The populated <code>FieldsStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FieldsStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>FieldsStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FieldsStatus</code>.
     */
 ...
 */
FieldsStatus.prototype['description'] = undefined;

/**
 * The URL of the icon used to represent the status.
 * @member {String} iconUrl
 */
FieldsStatus.prototype['iconUrl'] = undefined;

/**
 * The ID of the status.
 * @member {String} id
 */
FieldsStatus.prototype['id'] = undefined;

/**
 * The name of the status.
 * @member {String} name
 */
FieldsStatus.prototype['name'] = undefined;

/**
 * @member {module:model/StatusDetailsScope} scope
 */
FieldsStatus.prototype['scope'] = undefined;

/**
 * The URL of the status.
 * @member {String} self
 */
FieldsStatus.prototype['self'] = undefined;

/**
 * @member {module:model/StatusDetailsStatusCategory} statusCategory
 */
FieldsStatus.prototype['statusCategory'] = undefined;
