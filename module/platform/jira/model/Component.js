...
class Component {
     ...
     * @param schemaVersion {module:model/Component.SchemaVersionEnum} The DevOpsComponentData schema version used for this devops component data.  Placeholder to support potential schema changes in the future. 
     ...
     * @param tier {module:model/Component.TierEnum} The tier of the component. Will be shown in the UI. 
     * @param componentType {module:model/Component.ComponentTypeEnum} The type of the component. Will be shown in the UI. 
    ...
    constructor(schemaVersion, id, updateSequenceNumber, name, description, url, avatarUrl, tier, componentType, lastUpdated) { 
        ...
        Component.initialize(this, schemaVersion, id, updateSequenceNumber, name, description, url, avatarUrl, tier, componentType, lastUpdated);
    }
...
Component.RequiredProperties = ["schemaVersion", "id", "updateSequenceNumber", "name", "description", "url", "avatarUrl", "tier", "componentType", "lastUpdated"];
 ...
 * @member {module:model/Component.SchemaVersionEnum} schemaVersion
 * @default '1.0'
 */
Component.prototype['schemaVersion'] = '1.0';
 ...
 */
Component.prototype['updateSequenceNumber'] = undefined;
 ...
 */
Component.prototype['providerName'] = undefined;
 ...
 * @member {String} url
 */
Component.prototype['url'] = undefined;

/**
 * A URL to display a logo representing this devops component, if available. 
 * @member {String} avatarUrl
 */
Component.prototype['avatarUrl'] = undefined;

/**
 * The tier of the component. Will be shown in the UI. 
 * @member {module:model/Component.TierEnum} tier
 */
Component.prototype['tier'] = undefined;

/**
 * The type of the component. Will be shown in the UI. 
 * @member {module:model/Component.ComponentTypeEnum} componentType
 */
