...
class Field {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('stableId')) {
                obj['stableId'] = ApiClient.convertToType(data['stableId'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['stableId'] && !(typeof data['stableId'] === 'string' || data['stableId'] instanceof String)) {
            throw new Error("Expected the field `stableId` to be a primitive type in the JSON string but got " + data['stableId']);
        }
 ...
 */
Field.prototype['stableId'] = undefined;
