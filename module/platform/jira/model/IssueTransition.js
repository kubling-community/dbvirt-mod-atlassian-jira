...
import IssueTransitionTo from './IssueTransitionTo';
...
class IssueTransition {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('to')) {
                obj['to'] = IssueTransitionTo.constructFromObject(data['to']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['to']) { // data not null
          IssueTransitionTo.validateJSON(data['to']);
        }
...
/**
 * @member {module:model/IssueTransitionTo} to
 */
