...
/**
 * The ProjectDeletedBy model module.
 * @module model/ProjectDeletedBy
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class ProjectDeletedBy {
    /**
     * Constructs a new <code>ProjectDeletedBy</code>.
     * The user who marked the project as deleted.
     * @alias module:model/ProjectDeletedBy
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        ProjectDeletedBy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectDeletedBy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectDeletedBy} obj Optional instance to populate.
     * @return {module:model/ProjectDeletedBy} The populated <code>ProjectDeletedBy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectDeletedBy();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectDeletedBy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectDeletedBy</code>.
     */
 ...
 */
ProjectDeletedBy.prototype['accountId'] = undefined;

/**
 * The user account type. Can take the following values:   *  `atlassian` regular Atlassian user account  *  `app` system account used for Connect applications and OAuth to represent external systems  *  `customer` Jira Service Desk account representing an external service desk
 * @member {module:model/ProjectDeletedBy.AccountTypeEnum} accountType
 */
ProjectDeletedBy.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
ProjectDeletedBy.prototype['active'] = undefined;

/**
 * @member {module:model/UserApplicationRoles} applicationRoles
 */
ProjectDeletedBy.prototype['applicationRoles'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
ProjectDeletedBy.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
ProjectDeletedBy.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} emailAddress
 */
ProjectDeletedBy.prototype['emailAddress'] = undefined;

/**
 * Expand options that include additional user details in the response.
 * @member {String} expand
 */
ProjectDeletedBy.prototype['expand'] = undefined;

/**
 * @member {module:model/UserGroups} groups
 */
ProjectDeletedBy.prototype['groups'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
ProjectDeletedBy.prototype['key'] = undefined;

/**
 * The locale of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} locale
 */
ProjectDeletedBy.prototype['locale'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
ProjectDeletedBy.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
ProjectDeletedBy.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} timeZone
 */
ProjectDeletedBy.prototype['timeZone'] = undefined;
 ...
 * @readonly
 */
ProjectDeletedBy['AccountTypeEnum'] = {
...
export default ProjectDeletedBy;
