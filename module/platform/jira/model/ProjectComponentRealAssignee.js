...
/**
 * The ProjectComponentRealAssignee model module.
 * @module model/ProjectComponentRealAssignee
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class ProjectComponentRealAssignee {
    /**
     * Constructs a new <code>ProjectComponentRealAssignee</code>.
     * The user assigned to issues created with this component, when &#x60;assigneeType&#x60; does not identify a valid assignee.
     * @alias module:model/ProjectComponentRealAssignee
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        ProjectComponentRealAssignee.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectComponentRealAssignee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectComponentRealAssignee} obj Optional instance to populate.
     * @return {module:model/ProjectComponentRealAssignee} The populated <code>ProjectComponentRealAssignee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectComponentRealAssignee();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectComponentRealAssignee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectComponentRealAssignee</code>.
     */
 ...
 */
ProjectComponentRealAssignee.prototype['accountId'] = undefined;

/**
 * The user account type. Can take the following values:   *  `atlassian` regular Atlassian user account  *  `app` system account used for Connect applications and OAuth to represent external systems  *  `customer` Jira Service Desk account representing an external service desk
 * @member {module:model/ProjectComponentRealAssignee.AccountTypeEnum} accountType
 */
ProjectComponentRealAssignee.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
ProjectComponentRealAssignee.prototype['active'] = undefined;

/**
 * @member {module:model/UserApplicationRoles} applicationRoles
 */
ProjectComponentRealAssignee.prototype['applicationRoles'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
ProjectComponentRealAssignee.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
ProjectComponentRealAssignee.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} emailAddress
 */
ProjectComponentRealAssignee.prototype['emailAddress'] = undefined;

/**
 * Expand options that include additional user details in the response.
 * @member {String} expand
 */
ProjectComponentRealAssignee.prototype['expand'] = undefined;

/**
 * @member {module:model/UserGroups} groups
 */
ProjectComponentRealAssignee.prototype['groups'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
ProjectComponentRealAssignee.prototype['key'] = undefined;

/**
 * The locale of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} locale
 */
ProjectComponentRealAssignee.prototype['locale'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
ProjectComponentRealAssignee.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
ProjectComponentRealAssignee.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} timeZone
 */
ProjectComponentRealAssignee.prototype['timeZone'] = undefined;
 ...
 * @readonly
 */
ProjectComponentRealAssignee['AccountTypeEnum'] = {
...
export default ProjectComponentRealAssignee;
