...
/**
 * The ProjectAvatarUrls model module.
 * @module model/ProjectAvatarUrls
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class ProjectAvatarUrls {
    /**
     * Constructs a new <code>ProjectAvatarUrls</code>.
     * The URLs of the project&#39;s avatars.
     * @alias module:model/ProjectAvatarUrls
     * @implements module:model/AvatarUrlsBean
     */
    constructor() { 
        AvatarUrlsBean.initialize(this);
        ProjectAvatarUrls.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectAvatarUrls</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectAvatarUrls} obj Optional instance to populate.
     * @return {module:model/ProjectAvatarUrls} The populated <code>ProjectAvatarUrls</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectAvatarUrls();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectAvatarUrls</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectAvatarUrls</code>.
     */
 ...
 * @member {String} 16x16
 */
ProjectAvatarUrls.prototype['16x16'] = undefined;

/**
 * The URL of the item's 24x24 pixel avatar.
 * @member {String} 24x24
 */
ProjectAvatarUrls.prototype['24x24'] = undefined;

/**
 * The URL of the item's 32x32 pixel avatar.
 * @member {String} 32x32
 */
ProjectAvatarUrls.prototype['32x32'] = undefined;

/**
 * The URL of the item's 48x48 pixel avatar.
 * @member {String} 48x48
 */
ProjectAvatarUrls.prototype['48x48'] = undefined;
...
export default ProjectAvatarUrls;
