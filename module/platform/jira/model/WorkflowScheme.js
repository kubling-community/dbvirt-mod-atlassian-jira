...
import WorkflowSchemeLastModifiedUser from './WorkflowSchemeLastModifiedUser';
...
class WorkflowScheme {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('lastModifiedUser')) {
                obj['lastModifiedUser'] = WorkflowSchemeLastModifiedUser.constructFromObject(data['lastModifiedUser']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['lastModifiedUser']) { // data not null
          WorkflowSchemeLastModifiedUser.validateJSON(data['lastModifiedUser']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/WorkflowSchemeLastModifiedUser} lastModifiedUser
 */
