...
import DeprecatedWorkflowScope from './DeprecatedWorkflowScope';
...
class DeprecatedWorkflow {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scope')) {
                obj['scope'] = DeprecatedWorkflowScope.constructFromObject(data['scope']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['scope']) { // data not null
          DeprecatedWorkflowScope.validateJSON(data['scope']);
        }
...
/**
 * @member {module:model/DeprecatedWorkflowScope} scope
 */
