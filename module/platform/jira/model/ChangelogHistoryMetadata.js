...
/**
 * The ChangelogHistoryMetadata model module.
 * @module model/ChangelogHistoryMetadata
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class ChangelogHistoryMetadata {
    /**
     * Constructs a new <code>ChangelogHistoryMetadata</code>.
     * The history metadata associated with the changed.
     * @alias module:model/ChangelogHistoryMetadata
     * @implements module:model/HistoryMetadata
     */
    constructor() { 
        HistoryMetadata.initialize(this);
        ChangelogHistoryMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChangelogHistoryMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChangelogHistoryMetadata} obj Optional instance to populate.
     * @return {module:model/ChangelogHistoryMetadata} The populated <code>ChangelogHistoryMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChangelogHistoryMetadata();
            HistoryMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ChangelogHistoryMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChangelogHistoryMetadata</code>.
     */
 ...
 */
ChangelogHistoryMetadata.prototype['activityDescription'] = undefined;

/**
 * The key of the activity described in the history record.
 * @member {String} activityDescriptionKey
 */
ChangelogHistoryMetadata.prototype['activityDescriptionKey'] = undefined;

/**
 * Details of the user whose action created the history record.
 * @member {module:model/HistoryMetadataParticipant} actor
 */
ChangelogHistoryMetadata.prototype['actor'] = undefined;

/**
 * Details of the cause that triggered the creation the history record.
 * @member {module:model/HistoryMetadataParticipant} cause
 */
ChangelogHistoryMetadata.prototype['cause'] = undefined;

/**
 * The description of the history record.
 * @member {String} description
 */
ChangelogHistoryMetadata.prototype['description'] = undefined;

/**
 * The description key of the history record.
 * @member {String} descriptionKey
 */
ChangelogHistoryMetadata.prototype['descriptionKey'] = undefined;

/**
 * The description of the email address associated the history record.
 * @member {String} emailDescription
 */
ChangelogHistoryMetadata.prototype['emailDescription'] = undefined;

/**
 * The description key of the email address associated the history record.
 * @member {String} emailDescriptionKey
 */
ChangelogHistoryMetadata.prototype['emailDescriptionKey'] = undefined;

/**
 * Additional arbitrary information about the history record.
 * @member {Object.<String, String>} extraData
 */
ChangelogHistoryMetadata.prototype['extraData'] = undefined;

/**
 * Details of the system that generated the history record.
 * @member {module:model/HistoryMetadataParticipant} generator
 */
ChangelogHistoryMetadata.prototype['generator'] = undefined;

/**
 * The type of the history record.
 * @member {String} type
 */
ChangelogHistoryMetadata.prototype['type'] = undefined;


// Implement HistoryMetadata interface:
/**
 * The activity described in the history record.
 * @member {String} activityDescription
 */
...
export default ChangelogHistoryMetadata;
