...
import SecurityLevelMemberHolder from './SecurityLevelMemberHolder';
...
class SecurityLevelMember {
     ...
     * @extends Object
     * @param holder {module:model/SecurityLevelMemberHolder} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('holder')) {
                obj['holder'] = SecurityLevelMemberHolder.constructFromObject(data['holder']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['holder']) { // data not null
          SecurityLevelMemberHolder.validateJSON(data['holder']);
        }
...
/**
 * @member {module:model/SecurityLevelMemberHolder} holder
 */
 ...
 */
SecurityLevelMember.prototype['managed'] = undefined;
