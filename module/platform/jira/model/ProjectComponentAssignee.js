...
/**
 * The ProjectComponentAssignee model module.
 * @module model/ProjectComponentAssignee
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class ProjectComponentAssignee {
    /**
     * Constructs a new <code>ProjectComponentAssignee</code>.
     * The details of the user associated with &#x60;assigneeType&#x60;, if any. See &#x60;realAssignee&#x60; for details of the user assigned to issues created with this component.
     * @alias module:model/ProjectComponentAssignee
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        ProjectComponentAssignee.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectComponentAssignee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectComponentAssignee} obj Optional instance to populate.
     * @return {module:model/ProjectComponentAssignee} The populated <code>ProjectComponentAssignee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectComponentAssignee();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectComponentAssignee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectComponentAssignee</code>.
     */
 ...
 */
ProjectComponentAssignee.prototype['accountId'] = undefined;

/**
 * The user account type. Can take the following values:   *  `atlassian` regular Atlassian user account  *  `app` system account used for Connect applications and OAuth to represent external systems  *  `customer` Jira Service Desk account representing an external service desk
 * @member {module:model/ProjectComponentAssignee.AccountTypeEnum} accountType
 */
ProjectComponentAssignee.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
ProjectComponentAssignee.prototype['active'] = undefined;

/**
 * @member {module:model/UserApplicationRoles} applicationRoles
 */
ProjectComponentAssignee.prototype['applicationRoles'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
ProjectComponentAssignee.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
ProjectComponentAssignee.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} emailAddress
 */
ProjectComponentAssignee.prototype['emailAddress'] = undefined;

/**
 * Expand options that include additional user details in the response.
 * @member {String} expand
 */
ProjectComponentAssignee.prototype['expand'] = undefined;

/**
 * @member {module:model/UserGroups} groups
 */
ProjectComponentAssignee.prototype['groups'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
ProjectComponentAssignee.prototype['key'] = undefined;

/**
 * The locale of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} locale
 */
ProjectComponentAssignee.prototype['locale'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
ProjectComponentAssignee.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
ProjectComponentAssignee.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} timeZone
 */
ProjectComponentAssignee.prototype['timeZone'] = undefined;
 ...
 * @readonly
 */
ProjectComponentAssignee['AccountTypeEnum'] = {
...
export default ProjectComponentAssignee;
