...
/**
 * The AttachmentMetadataAuthor model module.
 * @module model/AttachmentMetadataAuthor
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class AttachmentMetadataAuthor {
    /**
     * Constructs a new <code>AttachmentMetadataAuthor</code>.
     * Details of the user who attached the file.
     * @alias module:model/AttachmentMetadataAuthor
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        AttachmentMetadataAuthor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachmentMetadataAuthor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachmentMetadataAuthor} obj Optional instance to populate.
     * @return {module:model/AttachmentMetadataAuthor} The populated <code>AttachmentMetadataAuthor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachmentMetadataAuthor();
    ...
    /**
     * Validates the JSON data with respect to <code>AttachmentMetadataAuthor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttachmentMetadataAuthor</code>.
     */
 ...
 */
AttachmentMetadataAuthor.prototype['accountId'] = undefined;

/**
 * The user account type. Can take the following values:   *  `atlassian` regular Atlassian user account  *  `app` system account used for Connect applications and OAuth to represent external systems  *  `customer` Jira Service Desk account representing an external service desk
 * @member {module:model/AttachmentMetadataAuthor.AccountTypeEnum} accountType
 */
AttachmentMetadataAuthor.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
AttachmentMetadataAuthor.prototype['active'] = undefined;

/**
 * @member {module:model/UserApplicationRoles} applicationRoles
 */
AttachmentMetadataAuthor.prototype['applicationRoles'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
AttachmentMetadataAuthor.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
AttachmentMetadataAuthor.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} emailAddress
 */
AttachmentMetadataAuthor.prototype['emailAddress'] = undefined;

/**
 * Expand options that include additional user details in the response.
 * @member {String} expand
 */
AttachmentMetadataAuthor.prototype['expand'] = undefined;

/**
 * @member {module:model/UserGroups} groups
 */
AttachmentMetadataAuthor.prototype['groups'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
AttachmentMetadataAuthor.prototype['key'] = undefined;

/**
 * The locale of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} locale
 */
AttachmentMetadataAuthor.prototype['locale'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
AttachmentMetadataAuthor.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
AttachmentMetadataAuthor.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} timeZone
 */
AttachmentMetadataAuthor.prototype['timeZone'] = undefined;
 ...
 * @readonly
 */
AttachmentMetadataAuthor['AccountTypeEnum'] = {
...
export default AttachmentMetadataAuthor;
