...
import ProjectRoleScope from './ProjectRoleScope';
...
class ProjectRole {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scope')) {
                obj['scope'] = ProjectRoleScope.constructFromObject(data['scope']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['scope']) { // data not null
          ProjectRoleScope.validateJSON(data['scope']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ProjectRoleScope} scope
 */
