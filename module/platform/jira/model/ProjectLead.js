...
/**
 * The ProjectLead model module.
 * @module model/ProjectLead
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class ProjectLead {
    /**
     * Constructs a new <code>ProjectLead</code>.
     * The username of the project lead.
     * @alias module:model/ProjectLead
     * @implements module:model/User
     */
    constructor() { 
        User.initialize(this);
        ProjectLead.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectLead</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectLead} obj Optional instance to populate.
     * @return {module:model/ProjectLead} The populated <code>ProjectLead</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectLead();
    ...
    /**
     * Validates the JSON data with respect to <code>ProjectLead</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProjectLead</code>.
     */
 ...
 */
ProjectLead.prototype['accountId'] = undefined;

/**
 * The user account type. Can take the following values:   *  `atlassian` regular Atlassian user account  *  `app` system account used for Connect applications and OAuth to represent external systems  *  `customer` Jira Service Desk account representing an external service desk
 * @member {module:model/ProjectLead.AccountTypeEnum} accountType
 */
ProjectLead.prototype['accountType'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
ProjectLead.prototype['active'] = undefined;

/**
 * @member {module:model/UserApplicationRoles} applicationRoles
 */
ProjectLead.prototype['applicationRoles'] = undefined;

/**
 * @member {module:model/UserAvatarUrls} avatarUrls
 */
ProjectLead.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
ProjectLead.prototype['displayName'] = undefined;

/**
 * The email address of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} emailAddress
 */
ProjectLead.prototype['emailAddress'] = undefined;

/**
 * Expand options that include additional user details in the response.
 * @member {String} expand
 */
ProjectLead.prototype['expand'] = undefined;

/**
 * @member {module:model/UserGroups} groups
 */
ProjectLead.prototype['groups'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} key
 */
ProjectLead.prototype['key'] = undefined;

/**
 * The locale of the user. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} locale
 */
ProjectLead.prototype['locale'] = undefined;

/**
 * This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
 * @member {String} name
 */
ProjectLead.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
ProjectLead.prototype['self'] = undefined;

/**
 * The time zone specified in the user's profile. Depending on the user’s privacy setting, this may be returned as null.
 * @member {String} timeZone
 */
ProjectLead.prototype['timeZone'] = undefined;
