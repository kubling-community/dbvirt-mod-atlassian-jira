...
import ServerInformationServerTimeZone from './ServerInformationServerTimeZone';
...
class ServerInformation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('displayUrlServicedeskHelpCenter')) {
                obj['displayUrlServicedeskHelpCenter'] = ApiClient.convertToType(data['displayUrlServicedeskHelpCenter'], 'String');
            }
            ...
            if (data.hasOwnProperty('serverTimeZone')) {
                obj['serverTimeZone'] = ServerInformationServerTimeZone.constructFromObject(data['serverTimeZone']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['displayUrlServicedeskHelpCenter'] && !(typeof data['displayUrlServicedeskHelpCenter'] === 'string' || data['displayUrlServicedeskHelpCenter'] instanceof String)) {
            throw new Error("Expected the field `displayUrlServicedeskHelpCenter` to be a primitive type in the JSON string but got " + data['displayUrlServicedeskHelpCenter']);
        }
        ...
        if (data['serverTimeZone']) { // data not null
          ServerInformationServerTimeZone.validateJSON(data['serverTimeZone']);
        }
        // ensure the json data is a string
 ...
 */
ServerInformation.prototype['displayUrl'] = undefined;

/**
 * The display URL of the Servicedesk Help Center.
 * @member {String} displayUrlServicedeskHelpCenter
 */
ServerInformation.prototype['displayUrlServicedeskHelpCenter'] = undefined;
...
/**
 * @member {module:model/ServerInformationServerTimeZone} serverTimeZone
 */
ServerInformation.prototype['serverTimeZone'] = undefined;
