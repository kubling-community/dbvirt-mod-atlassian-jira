...
class FunctionReferenceData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('supportsListAndSingleValueOperators')) {
                obj['supportsListAndSingleValueOperators'] = ApiClient.convertToType(data['supportsListAndSingleValueOperators'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['supportsListAndSingleValueOperators'] && !(typeof data['supportsListAndSingleValueOperators'] === 'string' || data['supportsListAndSingleValueOperators'] instanceof String)) {
            throw new Error("Expected the field `supportsListAndSingleValueOperators` to be a primitive type in the JSON string but got " + data['supportsListAndSingleValueOperators']);
        }
 ...
 * @member {module:model/FunctionReferenceData.SupportsListAndSingleValueOperatorsEnum} supportsListAndSingleValueOperators
 */
FunctionReferenceData.prototype['supportsListAndSingleValueOperators'] = undefined;
...
/**
 * Allowed values for the <code>supportsListAndSingleValueOperators</code> property.
 * @enum {String}
 * @readonly
 */
FunctionReferenceData['SupportsListAndSingleValueOperatorsEnum'] = {
