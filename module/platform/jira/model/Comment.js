...
import CommentUpdateAuthor from './CommentUpdateAuthor';
...
class Comment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('updateAuthor')) {
                obj['updateAuthor'] = CommentUpdateAuthor.constructFromObject(data['updateAuthor']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['updateAuthor']) { // data not null
          CommentUpdateAuthor.validateJSON(data['updateAuthor']);
        }
...
/**
 * @member {module:model/CommentUpdateAuthor} updateAuthor
 */
