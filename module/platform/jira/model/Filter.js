...
import FilterSharedUsers from './FilterSharedUsers';
...
class Filter {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('approximateLastUsed')) {
                obj['approximateLastUsed'] = ApiClient.convertToType(data['approximateLastUsed'], 'Date');
            }
            ...
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = FilterOwner.constructFromObject(data['owner']);
            }
            ...
            if (data.hasOwnProperty('sharedUsers')) {
                obj['sharedUsers'] = FilterSharedUsers.constructFromObject(data['sharedUsers']);
            }
            if (data.hasOwnProperty('subscriptions')) {
                obj['subscriptions'] = FilterSubscriptions.constructFromObject(data['subscriptions']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['owner']) { // data not null
          FilterOwner.validateJSON(data['owner']);
        }
        // ensure the json data is a string
        ...
        if (data['sharedUsers']) { // data not null
          FilterSharedUsers.validateJSON(data['sharedUsers']);
        }
        // validate the optional field `subscriptions`
        if (data['subscriptions']) { // data not null
          FilterSubscriptions.validateJSON(data['subscriptions']);
        }
        // ensure the json data is a string
 ...
 * @member {Date} approximateLastUsed
 */
Filter.prototype['approximateLastUsed'] = undefined;
...
/**
 * @member {module:model/FilterOwner} owner
 */
...
/**
 * @member {module:model/FilterSharedUsers} sharedUsers
 */
Filter.prototype['sharedUsers'] = undefined;

/**
 * @member {module:model/FilterSubscriptions} subscriptions
 */
