...
/**
 * The DashboardOwner model module.
 * @module model/DashboardOwner
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class DashboardOwner {
    /**
     * Constructs a new <code>DashboardOwner</code>.
     * The owner of the dashboard.
     * @alias module:model/DashboardOwner
     * @implements module:model/UserBean
     */
    constructor() { 
        UserBean.initialize(this);
        DashboardOwner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DashboardOwner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DashboardOwner} obj Optional instance to populate.
     * @return {module:model/DashboardOwner} The populated <code>DashboardOwner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DashboardOwner();
            UserBean.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DashboardOwner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DashboardOwner</code>.
     */
 ...
 */
DashboardOwner.prototype['accountId'] = undefined;

/**
 * Whether the user is active.
 * @member {Boolean} active
 */
DashboardOwner.prototype['active'] = undefined;

/**
 * The avatars of the user.
 * @member {module:model/UserBeanAvatarUrls} avatarUrls
 */
DashboardOwner.prototype['avatarUrls'] = undefined;

/**
 * The display name of the user. Depending on the user’s privacy setting, this may return an alternative value.
 * @member {String} displayName
 */
DashboardOwner.prototype['displayName'] = undefined;
 ...
 * @member {String} key
 */
DashboardOwner.prototype['key'] = undefined;
 ...
 * @member {String} name
 */
DashboardOwner.prototype['name'] = undefined;

/**
 * The URL of the user.
 * @member {String} self
 */
DashboardOwner.prototype['self'] = undefined;


// Implement UserBean interface:
/**
 * The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*.
 * @member {String} accountId
 */
