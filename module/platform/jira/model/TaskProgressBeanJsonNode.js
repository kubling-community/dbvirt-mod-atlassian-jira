...
/**
 * The TaskProgressBeanJsonNode model module.
 * @module model/TaskProgressBeanJsonNode
 * @version 1001.0.0-SNAPSHOT-122db9bd6b089919e6465ce52fdce319d5a9dfb4
 */
class TaskProgressBeanJsonNode {
    /**
     * Constructs a new <code>TaskProgressBeanJsonNode</code>.
     * Details about a task.
     * @alias module:model/TaskProgressBeanJsonNode
     ...
     * @param status {module:model/TaskProgressBeanJsonNode.StatusEnum} The status of the task.
    ...
    /**
     * Constructs a <code>TaskProgressBeanJsonNode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaskProgressBeanJsonNode} obj Optional instance to populate.
     * @return {module:model/TaskProgressBeanJsonNode} The populated <code>TaskProgressBeanJsonNode</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaskProgressBeanJsonNode();
    ...
    /**
     * Validates the JSON data with respect to <code>TaskProgressBeanJsonNode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TaskProgressBeanJsonNode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TaskProgressBeanJsonNode.RequiredProperties) {
...
TaskProgressBeanJsonNode.RequiredProperties = ["elapsedRuntime", "id", "lastUpdate", "progress", "self", "status", "submitted", "submittedBy"];
 ...
 * @readonly
 */
TaskProgressBeanJsonNode['StatusEnum'] = {
...
export default TaskProgressBeanJsonNode;
