...
import IssueBeanChangelog from './IssueBeanChangelog';
import IssueBeanEditmeta from './IssueBeanEditmeta';
import IssueBeanOperations from './IssueBeanOperations';
...
class IssueBean {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('changelog')) {
                obj['changelog'] = IssueBeanChangelog.constructFromObject(data['changelog']);
            }
            if (data.hasOwnProperty('editmeta')) {
                obj['editmeta'] = IssueBeanEditmeta.constructFromObject(data['editmeta']);
            }
            ...
            if (data.hasOwnProperty('operations')) {
                obj['operations'] = IssueBeanOperations.constructFromObject(data['operations']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['changelog']) { // data not null
          IssueBeanChangelog.validateJSON(data['changelog']);
        }
        // validate the optional field `editmeta`
        if (data['editmeta']) { // data not null
          IssueBeanEditmeta.validateJSON(data['editmeta']);
        }
        ...
        if (data['operations']) { // data not null
          IssueBeanOperations.validateJSON(data['operations']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/IssueBeanChangelog} changelog
 */
IssueBean.prototype['changelog'] = undefined;

/**
 * @member {module:model/IssueBeanEditmeta} editmeta
 */
...
/**
 * @member {module:model/IssueBeanOperations} operations
 */
