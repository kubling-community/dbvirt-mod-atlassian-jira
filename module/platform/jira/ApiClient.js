...
class ApiClient {
     ...
     */
    constructor(basePath = contextVars.ATLASSIAN_URL) {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         */
        ...
        this.authentications = {
            'basicAuth': {
                type: 'oauth2Basic',
                accessToken: contextVars.ATLASSIAN_TOKEN
            }
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/1001.0.0/Javascript'
        };
    ...
    applyAuthToRequest(request, authNames) {
        authNames.forEach((authName) => {
            ...
            switch (auth.type) {
                ...
                case 'oauth2Basic':
                    if (auth.accessToken) {
                        request.headers["Authorization"] = 'Basic ' + auth.accessToken;
                    }
    ...
    */
    callApi(path, httpMethod, pathParams,
        ...
        if (contentType === 'application/x-www-form-urlencoded') {
            ...
            if (request.header === undefined || request.header === null || !request.header['Content-Type']) {
        ...
        if (callback) {
            ...
            if (resp.statusCode >= 400) {
                ...
                data = (!resp.content) ? {} : returnType ? this.deserialize(JSON.parse(resp.content), returnType) : JSON.parse(resp.content);
            }
