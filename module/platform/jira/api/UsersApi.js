...
export default class UsersApi {
    ...
    */
     ...
     * @param {module:model/UserColumnRequestBody} userColumnRequestBody The ID of a column to set. To set multiple columns, send multiple `columns` parameters.
     * @param {Object} opts Optional parameters
     * @param {String} [accountId] The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*.
     ...
     */
    setUserColumns(userColumnRequestBody, opts, callback) {
      opts = opts || {};
      let postBody = userColumnRequestBody;
      // verify the required parameter 'userColumnRequestBody' is set
      if (userColumnRequestBody === undefined || userColumnRequestBody === null) {
        throw new Error("Missing the required parameter 'userColumnRequestBody' when calling setUserColumns");
      }
