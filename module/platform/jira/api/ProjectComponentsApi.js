...
import PageBean2ComponentJsonBean from '../model/PageBean2ComponentJsonBean';
...
export default class ProjectComponentsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the findComponentsForProjects operation.
     * @callback module:api/ProjectComponentsApi~findComponentsForProjectsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PageBean2ComponentJsonBean} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} [projectIdsOrKeys] The project IDs and/or project keys (case sensitive).
     ...
     * @param {module:model/String} [orderBy] [Order](#ordering) the results by a field:   *  `description` Sorts by the component description.  *  `name` Sorts by component name.
     ...
     * @param {module:api/ProjectComponentsApi~findComponentsForProjectsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PageBean2ComponentJsonBean}
     */
    findComponentsForProjects(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'projectIdsOrKeys': this.apiClient.buildCollectionParam(opts['projectIdsOrKeys'], 'multi'),
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PageBean2ComponentJsonBean;
      return this.apiClient.callApi(
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [componentSource = 'jira')] The source of the components to return. Can be `jira` (default), `compass` or `auto`. When `auto` is specified, the API will return connected Compass components if the project is opted into Compass, otherwise it will return Jira components. Defaults to `jira`.
     ...
     */
    getProjectComponents(projectIdOrKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'componentSource': opts['componentSource']
      };
      let headerParams = {
      };
      let formParams = {
