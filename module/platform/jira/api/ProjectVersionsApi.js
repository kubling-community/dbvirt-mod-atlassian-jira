...
import VersionRelatedWork from '../model/VersionRelatedWork';
...
export default class ProjectVersionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createRelatedWork operation.
     * @callback module:api/ProjectVersionsApi~createRelatedWorkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VersionRelatedWork} data The data returned by the service call.
     ...
     * @param {String} id 
     * @param {module:model/VersionRelatedWork} versionRelatedWork 
     * @param {module:api/ProjectVersionsApi~createRelatedWorkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VersionRelatedWork}
     */
    createRelatedWork(id, versionRelatedWork, callback) {
      let postBody = versionRelatedWork;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling createRelatedWork");
      }
      // verify the required parameter 'versionRelatedWork' is set
      if (versionRelatedWork === undefined || versionRelatedWork === null) {
        throw new Error("Missing the required parameter 'versionRelatedWork' when calling createRelatedWork");
      }
      ...
      let returnType = VersionRelatedWork;
    ...
    /**
     * Callback function to receive the result of the deleteRelatedWork operation.
     * @callback module:api/ProjectVersionsApi~deleteRelatedWorkCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ProjectVersionsApi~deleteRelatedWorkCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteRelatedWork(versionId, relatedWorkId, callback) {
      let postBody = null;
      // verify the required parameter 'versionId' is set
      if (versionId === undefined || versionId === null) {
        throw new Error("Missing the required parameter 'versionId' when calling deleteRelatedWork");
      }
      // verify the required parameter 'relatedWorkId' is set
      if (relatedWorkId === undefined || relatedWorkId === null) {
        throw new Error("Missing the required parameter 'relatedWorkId' when calling deleteRelatedWork");
      }
    ...
    /**
     * Callback function to receive the result of the getRelatedWork operation.
     * @callback module:api/ProjectVersionsApi~getRelatedWorkCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/VersionRelatedWork>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The ID of the version.
     * @param {module:api/ProjectVersionsApi~getRelatedWorkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/VersionRelatedWork>}
     */
    getRelatedWork(id, callback) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getRelatedWork");
      }
    ...
    /**
     * Callback function to receive the result of the updateRelatedWork operation.
     * @callback module:api/ProjectVersionsApi~updateRelatedWorkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VersionRelatedWork} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The ID of the version to update the related work on. For the related work id, pass it to the input JSON.
     * @param {module:model/VersionRelatedWork} versionRelatedWork 
     * @param {module:api/ProjectVersionsApi~updateRelatedWorkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VersionRelatedWork}
     */
    updateRelatedWork(id, versionRelatedWork, callback) {
      let postBody = versionRelatedWork;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateRelatedWork");
      }
      // verify the required parameter 'versionRelatedWork' is set
      if (versionRelatedWork === undefined || versionRelatedWork === null) {
        throw new Error("Missing the required parameter 'versionRelatedWork' when calling updateRelatedWork");
      }
